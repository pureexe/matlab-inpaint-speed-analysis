...
for test_case_number = 1:5
    ...
    tic;
    [inpainted_splitbergman_image,loop] = SplitBergmanInpainter(toinpaint_image,lambda,theta,tolerant,GSiter,max_iteration);
    process_time = toc;
    ...
    imwrite(inpainted_splitbergman_image,sprintf('result_jacobi/case%d.png',test_case_number));
...
csvwrite('jacobi_gpu.csv',lab_result);
