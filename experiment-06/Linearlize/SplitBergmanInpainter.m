...
function [u,i] = SplitBergmanInpainter(original_image,lambda,theta,tolerant,delta,max_gauss_seidel,max_iteration)
    image_norm = 99999999; 
    i = 1;
    u = original_image;
    ...
    while image_norm > tolerant && i < max_iteration
        ...
        u = uSolver(u,w,original_image,b,lambda,theta,delta,max_gauss_seidel); %solve u
